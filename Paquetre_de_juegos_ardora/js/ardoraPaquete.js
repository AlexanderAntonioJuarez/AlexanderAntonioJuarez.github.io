...
$("#botonPechar").keydown(function(e){if (e.which!=9){PechaVentana();}});$("#suggestPost").keydown(function(e){if (e.which!=9){$("#suggestPost").click();}})
   ...
   menuLateral='<h1> </h1><a class="lista" href="menuFiles/1ml_Ordenar_parrafos.htm"target="_parent">Ordenar parrafos</a><a class="lista" href="menuFiles/2ml_Ordenar_frase.htm"target="_parent">Ordenar frases</a><a class="lista" href="menuFiles/3ml_Colorear_segun_leyenda.htm"target="_parent">Colorear segun leyenda</a>';
   menuActividades='<h1></h1><a href="javascript:irA(0)" title="Colorear segun leyenda">1 </a><a href="javascript:irA(1)" title="Ordenar frases">2 </a><a href="javascript:irA(2)" title="Ordenar parrafos">3 </a>';
...
taboaContidos[0]=new act("Colorear segun leyenda","Colorear segun leyenda","","<object width='100%' height='420' type='text/html' data='Colorear_segun_leyenda/Colorear_segun_leyenda.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Ordenar frases","Ordenar frases","","<object width='100%' height='420' type='text/html' data='Ordenar_frase/Ordenar_frase.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("Ordenar parrafos","Ordenar parrafos","","<object width='100%' height='420' type='text/html' data='Ordenar_parrafos/Ordenar_parrafos.htm'></object>",false,"",true,true,true);
