...
taboaContidos[0]=new act("Alexander Juarez","Alexander Juarez","","<object width='100%' height='420' type='text/html' data='Alexander_Juarez/Alexander_Juarez.htm'></object>",false,"",false,true,true);
taboaContidos[1]=new act("Ronald Franco","Ronald Franco","","<object width='100%' height='420' type='text/html' data='Ronald_Franco/Ronald_Franco.htm'></object>",false,"",false,true,true);
taboaContidos[2]=new act("Melanie Hernandez","Melanie Hernandez","","<object width='100%' height='420' type='text/html' data='Melanie_Hernandez/Melanie_Hernandez.htm'></object>",false,"",false,true,true);
taboaContidos[3]=new act("Cesar Hernandez","Cesar Hernandez","","<object width='100%' height='420' type='text/html' data='Cesar_Hernandez/Cesar_Hernandez.htm'></object>",false,"",false,true,true);
taboaContidos[4]=new act("Sarai Hernandez","Sarai Hernandez","","<object width='100%' height='420' type='text/html' data='Sarai_Hernandez/Sarai_Hernandez.htm'></object>",false,"",false,true,true);
taboaContidos[5]=new act("Mia Hernandez","Mia Hernandez","","<object width='100%' height='420' type='text/html' data='Mia_Hernandez/Mia_Hernandez.htm'></object>",false,"",false,true,true);
